...
export const metadata: Metadata = { title: 'DrishtiAI — Explainable retinal screening support', description: 'A transparent decision-support workflow for diabetic retinopathy screening.' };
